...
def calculates_results_stats(results_dic):
    ...
    n_dogs_img = sum(1 for r in results_dic.values() if r[3] == 1)
    n_notdogs_img = n_images - n_dogs_img
    n_match = sum(1 for r in results_dic.values() if r[2] == 1)
    n_correct_dogs = sum(1 for r in results_dic.values() if r[3] == 1 and r[4] == 1)
    n_correct_notdogs = sum(1 for r in results_dic.values() if r[3] == 0 and r[4] == 0)
    n_correct_breed = sum(1 for r in results_dic.values() if r[2] == 1 and r[3] == 1)
